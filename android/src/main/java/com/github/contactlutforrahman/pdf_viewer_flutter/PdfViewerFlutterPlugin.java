...
/**
 * PdfViewerFlutterPlugin
 */
public class PdfViewerFlutterPlugin implements MethodCallHandler, PluginRegistry.ActivityResultListener {
  static MethodChannel channel;
  private Activity activity;
  private PdfViewerManager pdfViewerManager;

  private PdfViewerFlutterPlugin (Activity activity) {
